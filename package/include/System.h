...
public:
    ...
    cv::Mat GetCurrentDynamicMask();
    cv::Mat GetCurrentEstimatedDepth();
    FrameTelemetry GetCurrentFrameTelemetry();
    FrameTelemetry GetPreviousFrameTelemetry();
    long unsigned int GetCurrentFrameId();
