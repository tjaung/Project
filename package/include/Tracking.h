...
public:
    ...
    float GetImageScale();
    cv::Mat GetCurrentDynamicMask() const;
    cv::Mat GetCurrentEstimatedDepth() const;
    Sophus::SE3f GetCurrentPose() const;
    FrameTelemetry GetCurrentFrameTelemetry() const;
    FrameTelemetry GetPreviousFrameTelemetry() const;
...
public:
    ...
    FrameTelemetry mCurrentFrameTelemetry;
    FrameTelemetry mPreviousFrameTelemetry;
